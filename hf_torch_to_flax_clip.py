...
os.environ["CUDA_VISIBLE_DEVICES"] = "" # Remove any GPU, we do not want to use GPU

import jax
"""
Flax of HuggingFace auto compile using max position embeddings

This is troublesome if the model is already scaled using position embeddings extension
such as YaRN or RoPE.

This is why we keep splitting them up in below examples
"""
